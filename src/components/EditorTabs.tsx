  ...
  return (
    <Tab.Group selectedIndex={selectedIndex}>
      <div className="flex">
            ...
            {({ selected }) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 top-0 flex justify-center gap-1 px-2 py-1">
                  ...
                  <div className="flex items-center text-sm">画布</div>
                </div>
              </button>
            )}
          </Tab>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 top-0 flex cursor-pointer justify-center gap-1 px-4 pb-1 pt-1">
                  ...
                  <div className="flex items-center">
                    <span className="block truncate text-sm">代码</span>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="ml-auto flex shrink-0 flex-nowrap items-center gap-2 pl-4">
          <Link
            href="/new"
            type="button"
            className="inline-flex shrink-0 items-center whitespace-nowrap rounded-md bg-white px-3 py-1.5 text-sm font-medium text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
          >
          ...
          <button
            className="inline-flex shrink-0 items-center whitespace-nowrap rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-medium text-white shadow-sm hover:bg-indigo-700"
            onClick={async (e) => {
              e.preventDefault();
              try {
